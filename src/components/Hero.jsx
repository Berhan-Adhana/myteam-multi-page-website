...
const Hero = ({ children }) => {
  return (
    <section className="flex pt-[100px] px-6 pb-[197px] flex-col  lg:flex-row  relative lg:px-[165px] lg:py-[140px] items-center lg:gap-x-[30px] overflow-hidden">
      ...
      {/* Hero content */}
      <p className="body1 relative  before:hidden lg:before:block before:content-[''] before:absolute before:top-[-70px] before:w-[56px] before:h-1 before:bg-[var(--rapture-blue)]">
