      ...
      <div className=" flex md:hidden  mx-6 md:mx-10 pt-12 justify-between items-center   ">
        <Link to="/">
          <svg
            ...
            className="w-[160px] h-10 cursor-pointer "
          >
            <path
              fill="#FFF"
        ...
        <div
          className={`fixed w-[95%] bg-[var(--police-blue)] h-screen transition-all overflow-x-hidden ${
            openMenu ? "top-0 right-0" : "right-[-100%]"
          } `}
        >
          <ul className="flex flex-col justify-center items-center text-[18px] leading-7 font-semibold ">
